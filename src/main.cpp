...
int main() {
    ...
    MyClassShader ourShader("/Users/paolomazzon/Desktop/Progettic++/OPENGL/LearnOpenglXcode1/shaders/vertex.glsl", "/Users/paolomazzon/Desktop/Progettic++/OPENGL/LearnOpenglXcode1/shaders/fragment.glsl");
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW);//Ë una funzione specificatamente mirata per copiare i dati definiti dall'utente nel buffer attualmente associato
    ...
    glBindVertexArray(VAO);// visto che abbiamo un solo VAO non Ë necessario vincolarlo ogni volta, ma lo faremo per mantenere le cose un po 'pi˘ organizzate
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // glBindVertexArray (0); // non Ë necessario svincolarlo ogni volta
